...
class _VoucherManagementScreenState extends State<VoucherManagementScreen> {
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      _showEditDialog(context, data,
                                          document.id); // Mở dialog chỉnh sửa
                                    },
                                  ),
                                  IconButton(
              ...
              child: DataTable(
                ...
                rows: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Text(
                        data['voucherID']?.toString() ?? 'No Voucher Code')),
                  ]),
                  DataRow(cells: [
                    DataCell(Text('Discount')),
                    DataCell(
                        Text(data['discount']?.toString() ?? 'No Discount')),
                  ]),
                  DataRow(cells: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Text(
                        data['endDate']?.toDate().toString() ?? 'No End Date')),
                  ]),
                  DataRow(cells: [
                    DataCell(Text('Max Discount')),
                    DataCell(Text(
                        data['maxDiscount']?.toString() ?? 'No Max Discount')),
                  ]),
                  DataRow(cells: [
  ...
  void _showEditDialog(
    ...
    TextEditingController voucherIDController =
        TextEditingController(text: data['voucherID']?.toString());
    ...
    TextEditingController startDateController =
        TextEditingController(text: data['startDate']?.toDate().toString());
    TextEditingController endDateController =
        TextEditingController(text: data['endDate']?.toDate().toString());
    TextEditingController maxDiscountController =
        TextEditingController(text: data['maxDiscount']?.toString());
    TextEditingController statusController =
        TextEditingController(text: data['status']?.toString());
