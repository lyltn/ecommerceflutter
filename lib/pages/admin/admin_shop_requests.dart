...
class AdminShopRequestsPage extends StatelessWidget {
  ...
  final String smtpUsername = 'your-email@gmail.com';
  final String smtpPassword = 'your-email-password';
              ...
              return ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text('Email người dùng: ${doc['userEmail']}'),
